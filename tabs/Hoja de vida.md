...
*Analyst in risk methodologies* <br />
from Dec. 19 – Feb. 2021 <br />
<u> Job description: </u>
...
Director with the requirements that arise in risk management.
 ...
 + I automized more than 5 processes of extraction, generation, and periodic submission of databases with python. 
+ Develop informs in Data Studio based on the tables generated in Google Cloud Big Query.


#### [QNT S.A.S](https://qnt.com.co/)

*Analyst in operation analytics* <br />
from Apr. 19 – to Dec. 19 <br />
<u> Job description: </u>

+ Interpret the portfolio bases of the allies according to their client profile, analyze the results obtained by the Qbk Model and provide reports of said results found.
+ Communicate and correct incidents in the Salesforce platform to improve the development of Call Center tasks, as well as generate periodic reports through control panels.
 + Improve response times in database processing thanks to the structuring and automation of processes through Python.
 + Structure the area of data management, standardizing processes of reception, analysis, and reporting for each database.
+ Develop and generate automatic reports on the Qlik platform.
+ Identify patterns and trends in databases to improve QBK Model processes.

#### [Allianz Colombia, Casa Principal](https://www.allianz.co/)

*Internship in car management* <br />
from Jul. 18 - to Jan. 19 <br />
<u> Job description: </u>

+ Manage databases and analyze unrenewed home policies month by month for renewal.
+ Merge databases for homologation of 'Fasecolda' Codes according to updated data month by month.
+ Follow up on implementation and response processes in terms of insurability inspections and restriction analysis of vehicle license plates for policy issuance.
 + I optimized and standardized the elaboration of the tasks of the position reducing the response time from 3 to 1 day.

### Skills

|Program|Level|Program|Level|
|--|--|--|--|--|
|Python|Intermediate|R|Entry Level|
|SQL|Intermediate|Latex|Intermedio|
|Google Data Studio|Intermediate|Qlik|Intermediate|
|Stata|Intermediate|Microsoft  Office|Intermediate|
